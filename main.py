...
from excel_saver import find_excel_file, open_workbook, save_workbook, find_variant_sheet, get_all_students, find_student_row, write_scores_to_sheet
...
class BlankOCRApp:
    ...
    def start_scan(self):
        ...
        if score:
            ...
            ttk.Button(btn_frame, text="Закрыть (ESC)", command=result_win.destroy).pack(side=tk.LEFT, padx=5)
